      ...
      <div class="topbar-account topbar-btn">
        <el-dropdown trigger="click">
          ...
          <el-dropdown-menu slot="dropdown">
            ...
            -->
            <el-dropdown-item><router-link :to="'/auth/user/changepwd'">修改密码</router-link></el-dropdown-item>
      ...
      <aside :class="collapsed?'menu-collapsed':'menu-expanded'">
        ...
        <el-menu v-show="!collapsed" default-active="0" @open="handleOpen" @close="handleClose" router>
          <template v-for="(item,index) in $router.options.routes" v-if="item.menuShow">
            ...
            <el-menu-item v-else-if="item.leaf&&item.children&&item.children.length" v-show="adminDisplay" :index="item.children[0].path" class="el-submenu__title">
